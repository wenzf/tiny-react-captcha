...
export const drawCaptchaOnCanvas = (ctx, captcha, perferedTheme) => {
    ...
    for (let i = 0; i < captcha.length; i += 1) {
        ...
        if (randomNumber(0, 1) === 0) {
            ctx.fillText(captcha[i], xInitialSpace + i * letterSpace, Math.floor(randomNumber(0, 1) * letterSize + xInitialSpace), 50);
        }
        else {
