...
export const checkBehaviour = (behaviour) => {
...
export const onUserInputCB = (type, e, behaviour, clientInfo) => {
...
export const isStrangeDimension = (screenXorY) => {
    let initialValue = 0;
